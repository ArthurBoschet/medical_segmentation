...
def conv_output_dim(input_dim, kernel_size, stride, padding, dilation):
  '''
...
def transpose_conv_output_dim(input_dim, kernel_size, stride, padding, dilation):
  '''
...
def conv3d_output_dim(input_dim, num_kernels, kernel_size, stride, padding, dilation, type='normal'):
  '''
  ...
  spacial_dims = [conv_output_dim(input_dim[2+i], kernel_size[i], stride[i], padding[i], dilation[i]) for i in range(3)]
