...
def prepare_dataset_for_training_local(dataset_folder_path):
    '''
    Prepare the dataset for training by splitting it into training and validation sets for the dataloaders
    ...
    '''
    # paths
    train_images_files = sorted(os.listdir(os.path.join(dataset_folder_path, "imagesTr")))
    train_labels_files = sorted(os.listdir(os.path.join(dataset_folder_path, "labelsTr")))
    test_images_files = sorted(os.listdir(os.path.join(dataset_folder_path, "imagesTs")))

    # create train, val and test folders
    os.makedirs(os.path.join(dataset_folder_path, "train_val"))
    ...
    # remove useless folders
    shutil.rmtree(os.path.join(dataset_folder_path, "imagesTr"))
    shutil.rmtree(os.path.join(dataset_folder_path, "labelsTr"))
    shutil.rmtree(os.path.join(dataset_folder_path, "imagesTs"))
